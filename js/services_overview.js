         ...
         return {
            ...
            items: {
               'open': {
                  ...
                  {
                     window.location = Urls.p_service_view(data.id);
                  }
               },
               'edit': {
                  name: t['Properties'] + '...',
               ...
               'pause': {
                  ...
                  callback: function(itemKey, opt, e)
                  {
                     doubleCheck(
                        t['PauseService'],
                        t['SureToPause'].format(data.description),
                        t['Pause'],
                        function()
                        {
                           postUrl(
...
function create_table(elem, data)
{
   ...
   elem.on( 'click', '.dt-left', function ()
   {
